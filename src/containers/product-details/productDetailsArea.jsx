...
const ProductDetailsArea = ({ space, className, product,metaDataName }) =>{
 

    console.log("Contract Name",metaDataName);
        ...
        <div className="container">
            <div className="row g-5">
                <div className="col-lg-7 col-md-12 col-sm-12">
                    <Sticky>
                        <NewGalleryTab image={product.metadata.image} />
                    </Sticky>
                </div>
                        ...
                        <div className="catagory-collection">
                          ...
                          <ProductTitle
                            title={
                                ...
                                product.metadata.name.charAt(0).toUpperCase() +
                                product.metadata.name.slice(1)
                                }
                        />
