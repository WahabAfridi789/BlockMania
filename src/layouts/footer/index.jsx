        ...
        >
            ...
            <div className="container text-center">
                <div className="row gx-5">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 col-12 mt_mobile--40 mt_sm--40">
                        <QuicklinkWidget data={footerData["campaign-footer"]} />
                    </div>

                    <div className="col-lg-3 col-md-6 col-sm-6 col-12 mt_md--40 mt_sm--40">
                        <InformationWidget data={footerData["NFT-footer"]} />
                    </div>

                    <div className="col-lg-3 col-md-6 col-sm-6 col-12 mt_md--40 mt_sm--40">
                        <InformationWidget
                            data={footerData["contact-footer"]}
                        />
                    </div>
                </div>
            </div>
